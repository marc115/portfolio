export default function Me () {
    return (
        <div className="m-5 md:mx-32">
            <h1 className="font-bold text-5xl">I&aposm
            ...
            <p>A professional that learned to code both from a school and on my own, I don&apost shy away from searching online when the need calls for it.</p>
